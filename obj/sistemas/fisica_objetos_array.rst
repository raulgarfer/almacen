...
Hexadecimal [16-Bits]
                              ...
                              3 .include "datos/declaraciones.inc"
...
Hexadecimal [16-Bits]
                              ...
                              4 ;;//void fisica_objetos(){
                              5 ;;//    u8 i;
                              6 ;;//    for (i=1;i<max_entidades;i++){
                              7 ;;//    borra_objeto(array[i].x,array[i].y,array[i].ancho,array[i].alto);
                              8 ;;//    array[i].x+=array[i].vx;
                              9 ;;//    if (array[i].x==10)
                             10 ;;//        {comprobar_recojida(i);}
                             11 
   4A59                      12 _fisica_objetos_con_array::
   4A59 DD 21 0A 56   [14]   13     ld ix,#_array
                             14  
                             15 
   4A5D C9            [10]   16 ret
