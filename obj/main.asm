...
;src/main.c:16: iniciar_valores();
	call	_iniciar_valores
;src/main.c:18: mientras_juego();
	call	_mientras_juego
	ld	hl, #6
	add	hl, sp
	ld	sp, hl
	ret
;src/main.c:21: void mientras_juego(){
;	---------------------------------
...
;src/main.c:23: borra();
	call	_borra
;src/main.c:24: teclado();
	call	_teclado
;src/main.c:25: fisica();
	call	_fisica
;src/main.c:26: pintar_sprites();
	call	_pintar_sprites
;src/main.c:27: pinta_marcador();
