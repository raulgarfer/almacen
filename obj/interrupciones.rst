...
Hexadecimal [16-Bits]
   ...
   4271                      16 IR::
   4271 00                   17 .db 0
   4272                      18 _control_interrupciones::
   4272 ED 56         [ 8]   19     im 1
   4274 CD 6A 44      [17]   20     call cpct_waitVSYNC_asm
   4277 76            [ 4]   21     halt
   4278 76            [ 4]   22     halt
   4279 CD 6A 44      [17]   23     call cpct_waitVSYNC_asm
   427C F3            [ 4]   24     di
   427D 3E C3         [ 7]   25     ld a,#0xc3
   427F 32 38 00      [13]   26     ld (0x38),a
   4282 21 8A 42      [10]   27     ld hl,#int_1
   4285 22 39 00      [16]   28     ld (0x39),hl
   4288 FB            [ 4]   29     ei 
   4289 C9            [10]   30 ret
   428A                      31 int_1::
   0019                      32     cpctm_push af,bc,hl
                     0003     1    .narg v
                     0001     2    .if v
   428A F5            [11]    3    push af
                     0001     4    .if v-1
   428B C5            [11]    5    push bc
                     0001     6    .if v-2
   428C E5            [11]    7    push hl
                     0000     8    .if v-3
                              9    push 
                             10    .if v-4
                             11    push 
   ...
   428D 3E 01         [ 7]    1     ld a,#1
   428F 32 71 42      [13]    2     ld (IR),a
...
Hexadecimal [16-Bits]
   ...
   4292 21 A4 42      [10]    3     ld hl,#int_2
   4295 22 39 00      [16]    4     ld (0x39),hl
   ...
   4298 21 10 01      [10]    2    ld   hl, #0x110         ;; [3]  H=Hardware value of desired colour, L=Border INK (16)
   429B CD 5C 43      [17]    3    call cpct_setPALColour_asm  ;; [25] Set Palette colour of the border
                              3    .radix d
   ...
   42A0 F1            [10]    7    pop af
                     ...
                     0001    20    .else
                             21    .mexit
   42A1 FB            [ 4]   37     ei
   42A2 ED 4D         [14]   38 reti 
   42A4                      39 int_2::
   0033                      40    cpctm_push af,bc,hl
                     0003     1    .narg v
                     0001     2    .if v
   42A4 F5            [11]    3    push af
                     0001     4    .if v-1
   42A5 C5            [11]    5    push bc
                     0001     6    .if v-2
   42A6 E5            [11]    7    push hl
                     0000     8    .if v-3
                              9    push 
                             10    .if v-4
                             11    push 
...
Hexadecimal [16-Bits]
   ...
   42A7 3E 02         [ 7]    1     ld a,#2
   42A9 32 71 42      [13]    2     ld (IR),a
   003B                      42         siguiente_interrrupcion int_3
                              1 .globl cpct_setVideoMode_asm
                              2 .globl _pinta_marcador
   42AC 21 BE 42      [10]    3     ld hl,#int_3
   42AF 22 39 00      [16]    4     ld (0x39),hl
   ...
   0041                       2    cpctm_setBorder_raw_asm \2 ;; [28] Macro that does the job, but requires a number value to be passed
                              1    .globl cpct_setPALColour_asm
   42B2 21 10 02      [10]    2    ld   hl, #0x210         ;; [3]  H=Hardware value of desired colour, L=Border INK (16)
   42B5 CD 5C 43      [17]    3    call cpct_setPALColour_asm  ;; [25] Set Palette colour of the border
                              3    .radix d
   ...
   42BA F1            [10]    7    pop af
                     ...
                     0001    20    .else
                             21    .mexit
   42BB FB            [ 4]   45     ei
   42BC ED 4D         [14]   46 reti
   42BE                      47 int_3::
   004D                      48    cpctm_push af,bc,hl
                     0003     1    .narg v
                     0001     2    .if v
   42BE F5            [11]    3    push af
                     0001     4    .if v-1
   42BF C5            [11]    5    push bc
                     0001     6    .if v-2
   42C0 E5            [11]    7    push hl
                     0000     8    .if v-3
                              9    push 
                             10    .if v-4
                             11    push 
...
Hexadecimal [16-Bits]
   ...
   42C1 3E 03         [ 7]    1     ld a,#3
   42C3 32 71 42      [13]    2     ld (IR),a
   0055                      50         siguiente_interrrupcion int_4
                              1 .globl cpct_setVideoMode_asm
                              2 .globl _pinta_marcador
   42C6 21 E6 42      [10]    3     ld hl,#int_4
   42C9 22 39 00      [16]    4     ld (0x39),hl
   ...
   005B                       2    cpctm_setBorder_raw_asm \5 ;; [28] Macro that does the job, but requires a number value to be passed
                              1    .globl cpct_setPALColour_asm
   42CC 21 10 05      [10]    2    ld   hl, #0x510         ;; [3]  H=Hardware value of desired colour, L=Border INK (16)
   42CF CD 5C 43      [17]    3    call cpct_setPALColour_asm  ;; [25] Set Palette colour of the border
                              3    .radix d
   42D2 2E 00         [ 7]   52     ld l,#0                             ;;pen
   42D4 26 02         [ 7]   53     ld h,#2                             ;;ink
   42D6 CD 5C 43      [17]   54     call cpct_setPALColour_asm
   42D9 2E 01         [ 7]   55      ld l,#1                             ;;pen
   42DB 26 01         [ 7]   56     ld h,#1                            ;;ink
   42DD CD 5C 43      [17]   57     call cpct_setPALColour_asm
                             58     
...
Hexadecimal [16-Bits]
   ...
   42E4 ED 4D         [14]   61 reti
   42E6                      62 int_4::
   0075                      63   cpctm_push af,bc,hl
                     0003     1    .narg v
                     0001     2    .if v
   42E6 F5            [11]    3    push af
                     0001     4    .if v-1
   42E7 C5            [11]    5    push bc
                     0001     6    .if v-2
   42E8 E5            [11]    7    push hl
                     0000     8    .if v-3
                              9    push 
                             10    .if v-4
                             11    push 
   ...
   42E9 3E 04         [ 7]    1     ld a,#4
   42EB 32 71 42      [13]    2     ld (IR),a
   007D                      65         siguiente_interrrupcion int_5
                              1 .globl cpct_setVideoMode_asm
                              2 .globl _pinta_marcador
   42EE 21 0E 43      [10]    3     ld hl,#int_5
   42F1 22 39 00      [16]    4     ld (0x39),hl
   ...
   0083                       2    cpctm_setBorder_raw_asm \6 ;; [28] Macro that does the job, but requires a number value to be passed
                              1    .globl cpct_setPALColour_asm
   42F4 21 10 06      [10]    2    ld   hl, #0x610         ;; [3]  H=Hardware value of desired colour, L=Border INK (16)
   42F7 CD 5C 43      [17]    3    call cpct_setPALColour_asm  ;; [25] Set Palette colour of the border
                              3    .radix d
   42FA 0E 01         [ 7]   67       ld c,#1
                             68         ;;call cpct_setVideoMode_asm
   42FC CD E7 41      [17]   69         call _pinta_marcador
   42FF 0E 02         [ 7]   70         ld c,#2
                             71         ;;call cpct_setVideoMode_asm
   4301 2E 01         [ 7]   72       ld l,#1                             ;;pen
   4303 26 04         [ 7]   73     ld h,#4                             ;;ink
   4305 CD 5C 43      [17]   74     call cpct_setPALColour_asm
   0097                      75     cpctm_pop hl,bc,af
                     0003     1    .narg v
                     0001     2    .if v
   4308 E1            [10]    3    pop hl
                     0001     4    .if v-1
...
Hexadecimal [16-Bits]
                     ...
                     0001    20    .else
                             ...
                             76     
   430B FB            [ 4]   77     ei
   430C ED 4D         [14]   78 reti
   430E                      79 int_5::
   009D                      80   cpctm_push af,bc,hl
                     0003     1    .narg v
                     0001     2    .if v
   430E F5            [11]    3    push af
                     0001     4    .if v-1
   430F C5            [11]    5    push bc
                     0001     6    .if v-2
   4310 E5            [11]    7    push hl
                     0000     8    .if v-3
                              9    push 
                             10    .if v-4
                             11    push 
                     ...
                     0001    20    .else
                             21    .mexit
   00A0                      81         numero_interrupcion 5
   4311 3E 05         [ 7]    1     ld a,#5
   4313 32 71 42      [13]    2     ld (IR),a
   00A5                      82         siguiente_interrrupcion int_6
                              1 .globl cpct_setVideoMode_asm
                              2 .globl _pinta_marcador
   4316 21 28 43      [10]    3     ld hl,#int_6
   4319 22 39 00      [16]    4     ld (0x39),hl
   00AB                      83     cpctm_setBorder_asm 7
                              1    .radix h
   00AB                       2    cpctm_setBorder_raw_asm \7 ;; [28] Macro that does the job, but requires a number value to be passed
                              1    .globl cpct_setPALColour_asm
   431C 21 10 07      [10]    2    ld   hl, #0x710         ;; [3]  H=Hardware value of desired colour, L=Border INK (16)
   431F CD 5C 43      [17]    3    call cpct_setPALColour_asm  ;; [25] Set Palette colour of the border
                              3    .radix d
...
Hexadecimal [16-Bits]
   ...
   4324 F1            [10]    7    pop af
                     ...
                     0001    20    .else
                             21    .mexit
   4325 FB            [ 4]   85     ei
   4326 ED 4D         [14]   86 reti
   4328                      87 int_6::
   00B7                      88   cpctm_push af,bc,hl
                     0003     1    .narg v
                     0001     2    .if v
   4328 F5            [11]    3    push af
                     0001     4    .if v-1
   4329 C5            [11]    5    push bc
                     0001     6    .if v-2
   432A E5            [11]    7    push hl
                     0000     8    .if v-3
                              9    push 
                             10    .if v-4
                             11    push 
                     ...
                     0001    20    .else
                             21    .mexit
   00BA                      89         numero_interrupcion 6
   432B 3E 06         [ 7]    1     ld a,#6
   432D 32 71 42      [13]    2     ld (IR),a
   00BF                      90         siguiente_interrrupcion int_1
                              1 .globl cpct_setVideoMode_asm
                              2 .globl _pinta_marcador
   4330 21 8A 42      [10]    3     ld hl,#int_1
   4333 22 39 00      [16]    4     ld (0x39),hl
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 103.
Hexadecimal [16-Bits]



   00C5                      91     cpctm_setBorder_asm 8
                              1    .radix h
   00C5                       2    cpctm_setBorder_raw_asm \8 ;; [28] Macro that does the job, but requires a number value to be passed
                              1    .globl cpct_setPALColour_asm
   4336 21 10 08      [10]    2    ld   hl, #0x810         ;; [3]  H=Hardware value of desired colour, L=Border INK (16)
   4339 CD 5C 43      [17]    3    call cpct_setPALColour_asm  ;; [25] Set Palette colour of the border
                              3    .radix d
   433C 2E 00         [ 7]   92     ld l,#0                             ;;pen
   433E 26 01         [ 7]   93     ld h,#1                             ;;ink
   4340 CD 5C 43      [17]   94     call cpct_setPALColour_asm
   4343 2E 01         [ 7]   95      ld l,#1                             ;;pen
   4345 26 03         [ 7]   96     ld h,#3                             ;;ink
   4347 CD 5C 43      [17]   97     call cpct_setPALColour_asm
                             98     
   00D9                      99     cpctm_pop hl,bc,af
                     0003     1    .narg v
                     0001     2    .if v
   434A E1            [10]    3    pop hl
                     0001     4    .if v-1
